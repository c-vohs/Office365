...
Get-EXOMailbox -ResultSize Unlimited | Where{$_.DisplayName -notlike "Discovery Search Mailbox"} | ForEach-Object{
...
if((Test-Path -Path $ExportCSV) -eq "True")
{
 ...
 Write-Host `n~~ Check out """AdminDroid Office 365 Reports""" to get access to 950+ Office 365 reports. ~~`n -ForegroundColor Green
